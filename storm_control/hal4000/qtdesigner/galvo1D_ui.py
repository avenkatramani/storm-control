...
# Form implementation generated from reading ui file 'galvo1D.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.galvoVoltLabel = QtWidgets.QLabel(self.groupBox)
        self.galvoVoltLabel.setObjectName("galvoVoltLabel")
        self.verticalLayout.addWidget(self.galvoVoltLabel)
        ...
        self.goSpinBox.setFrame(True)
        self.goSpinBox.setReadOnly(False)
        self.goSpinBox.setDecimals(2)
        self.goSpinBox.setMinimum(-1000.0)
        self.goSpinBox.setMaximum(1000.0)
        self.goSpinBox.setSingleStep(0.05)
        self.goSpinBox.setStepType(QtWidgets.QAbstractSpinBox.DefaultStepType)
        self.goSpinBox.setProperty("value", 0.0)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox.setTitle(_translate("Dialog", "Volt (mV)"))
        self.galvoVoltLabel.setText(_translate("Dialog", "0.0"))
        self.zeroButton.setText(_translate("Dialog", "Zero"))
        self.moveToGroupBox.setTitle(_translate("Dialog", "Move To"))
        self.goLabel.setText(_translate("Dialog", "Volt (mV)"))
